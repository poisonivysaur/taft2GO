  ...
  <nav class="navbar navbar-expand-md bg-primary navbar-dark">
    <div class="collapse navbar-collapse text-center justify-content-end" id="navbar2SupportedContent">
      ...
      <a class="btn navbar-btn ml-2 text-white btn-link baloo" href="inbox.html">Inbox
        <br> </a>
      <a class="btn navbar-btn ml-2 btn-link baloo text-secondary" href="listing.html">Listings
        <br> </a>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-4 text-secondary">
          <a class="btn navbar-btn ml-2 btn-link baloo ml-auto text-left menu text-dark" href="listing.html">Listings</a>
          <a class="btn navbar-btn ml-2 btn-link baloo text-dark text-left ml-auto menu" href="listing-reservation.html">Reservations</a>
          <a class="btn navbar-btn ml-2 btn-link baloo ml-auto menu text-left text-secondary">Reservation Requirements</a>
        ...
        <div class="col-md-8">
          <div class="alert alert-success" role="alert">
            ...
            <p class="mb-0">Reservation requirements have been updated.</p>
          </div>
          <div class="card">
            <div class="card-header"> Identity</div>
            <div class="card-body">
              <p class=" p-y-1">Your guests will need to verify their ID before booking with you.&nbsp;
                <br> </p>
              <p class="">Before you can require guests to verify their ID, you’ll need to verify yours!&nbsp;</p>
              <p class="">Verify your ID to enable this requirement.</p>
              <a class="btn btn-primary baloo" href="">Save Reservation Requirements
                <br> </a>
            </div>
          </div>
        </div>
