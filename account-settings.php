      ...
      <div class="row">
        <div class="col-md-4 text-secondary">
          ...
          <a class="btn navbar-btn ml-2 btn-link baloo text-dark ml-auto menu text-left" href="account-transactions.html">Transaction History
            <br> </a>
          <a class="btn navbar-btn ml-2 btn-link baloo ml-auto menu text-left text-secondary" href="">Settings
            <br> </a>
        </div>
        <div class="col-md-8">
          <div class="card">
            ...
            <div class="card-body">
              <a class="btn btn-primary baloo" href="signup.html">Cancel my account</a>
            </div>
          </div>
        </div>
      </div>
