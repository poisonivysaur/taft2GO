    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 text-secondary">
          <h1 class="text-dark">Great progress, Olie!</h1>
          ...
          <h6 class="text-muted">Photos, short description, title</h6>
      ...
      <div class="row">
        <div class="col-md-3">
          <a href="addlisting.html" class="btn btn-outline-primary mx-0 w-100">Back</a>
        </div>
        <div class="col-md-3">
          <a class="btn btn-primary w-100" href="addlisting3.html">Next </a>
        </div>
      </div>
      <br> </div>
