  ...
  <nav class="navbar navbar-expand-md bg-primary navbar-dark">
    <div class="collapse navbar-collapse text-center justify-content-end" id="navbar2SupportedContent">
      ...
      <a class="btn navbar-btn ml-2 text-white btn-link baloo" href="stays.html">&gt;
        <br> </a>
      <a class="btn navbar-btn ml-2 text-white btn-link baloo" href="">3. Confirm &amp; Pay
        <br> </a>
    </div>
    <div class="container">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-7">
          ...
          <p class="lead"> </p>
          <p class="lead">Pay with&nbsp;</p>
          <div class="btn-group">
            <button class="btn btn-outline-primary dropdown-toggle" data-toggle="dropdown"> Select payment method
              <div class="dropdown-menu">
                <a class="dropdown-item" href="#">Action</a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="#">Separated link</a>
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <input class="form-control mr-sm-2" type="text" placeholder=""> </div>
            <div class="col-md-6">
          ...
          <div class="row">
            <div class="col-md-12">
              <p class="lead">Card info </p>
              <input class="form-control mr-sm-2" type="text" placeholder="Card number"> </div>
            <div class="col-md-6">
              <input class="form-control mr-sm-2" type="text" placeholder="Expiration"> </div>
            <div class="col-md-6">
              <input class="form-control mr-sm-2" type="text" placeholder="CVV"> </div>
          </div>
          <p class="lead"> </p>
          <div class="row">
            <div class="col-md-6">
          ...
          <p class="lead"> </p>
          <p class="lead">Cancellation policy: Strict</p>
          <p class="">Cancel up to 7 days before check in and get a 50% refund (minus service fees). Cancel within 7 days of your trip and the reservation is non-refundable. Service fees are refunded when cancellation happens before check in and within 48 hours of
            booking.</p>
          <br>
          <p class="">I agree to the House Rules, Cancellation Policy, and to the Guest Refund Policy. I also agree to pay the total amount shown, which includes Occupancy Taxes and Service Fees. Airbnb now collects and remits government-imposed Occupancy Taxes in
            this location.</p>
          <a class="btn btn-primary baloo w-50" href="">Request to Book
            <br> </a>
        </div>
        <div class="col-md-5">
          <div class="card">
