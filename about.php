...
<body>
  <nav class="navbar navbar-expand-md navbar-dark m-0 style transparent">
    ...
    <a href="search-results.html" class="btn btn-outline-primary baloo">Search
      <br> </a>
    ...
    <div class="container">
      <div class="row h-100">
        ...
        <div class="col-md-6">
          ...
          <h1 class="text-gray-dark baloo">About Us</h1>
          <form class="" method="post" action="https://formspree.io/">
            <p class="lead mb-5">Find the right place to stay.</p>
            <p class="">taft2GO is an online lodgin podium that caters to the Taft area residents in Manila</p>
          </form>
        </div>
      </div>
    </div>
