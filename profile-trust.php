    ...
    <div class="container">
      <div class="row">
        <div class="col-md-4 text-secondary">
          ...
          <a class="btn navbar-btn ml-2 btn-link baloo ml-auto menu text-left text-secondary" href="profile-trust.html">Trust and Verification</a>
        ...
        <div class="col-md-8">
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-12" style="transition: all 0.25s;">
                    <p class="lead">Be ready to book</p>
                    <p class="">You’ll need to provide identification before you book, so get a head start by doing it now.</p>
                    <a class="btn btn-primary baloo" href="view-profile.html">Provide ID
                      <br> </a>
                  </div>
                </div>
              </div>
          ...
          <p class="">&nbsp;</p>
          <div class="card">
            <div class="card-header"> Your verified info</div>
            <p class="">&nbsp;</p>
          </div>
          <p class="">&nbsp;</p>
          <div class="card">
            <div class="card-header"> Not yet verified</div>
            <div class="card-body">
              <h4>Email address</h4>
              <h6 class="text-muted">Please verify your email address by clicking the link in the message we just sent to: pr4vjmi3.by4@20minute.email</h6>
              <h6 class="text-muted">Can’t find our message? Check your spam folder or resend the confirmation email.</h6>
              <h6 class="text-muted">&nbsp;</h6>
              <h4>Phone number</h4>
              <h6 class="text-muted">Make it easier to communicate with a verified phone number. We’ll send you a code by SMS or read it to you over the phone. Enter the code below to confirm that you’re the person on the other end.</h6>
              <h6 class="text-muted">Your number is only shared with another Airbnb member once you have a confirmed booking.</h6>
              <h6 class="text-muted">&nbsp;</h6>
              <h6 class="text-muted">No phone number entered</h6>
              <div class="card-body">
              ...
              <div class="row">
                <div class="col-md-6">
                  <h4>Facebook</h4>
                  <h6 class="text-muted">Sign in with Facebook and discover your trusted connections to hosts and guests all over the world.</h6>
                </div>
                <div class="col-md-6">
                  <a href="#" class="btn btn-outline-primary baloo text-right">Connect</a>
                </div>
              </div>
              <h6 class="text-muted">&nbsp;</h6>
              <div class="row">
                <div class="col-md-6">
                  <h4>Google</h4>
                  <h6 class="text-muted">Connect your Airbnb account to your Google account for simplicity and ease.</h6>
                </div>
                <div class="col-md-6">
                  <a href="#" class="btn btn-outline-primary baloo">Connect</a>
                </div>
              </div>
              <h6 class="text-muted">&nbsp;</h6>
              <div class="row">
                <div class="col-md-6">
                  <h4>LinkedIn</h4>
                  <h6 class="text-muted">Create a link to your professional life by connecting your Airbnb and LinkedIn accounts.</h6>
                </div>
                <div class="col-md-6">
                  <a href="#" class="btn btn-outline-primary baloo">Connect</a>
                </div>
