      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="card">
            ...
            <div class="card-body">
              <p class=" p-y-1">This information can be edited from your profile page.&nbsp;</p>
              <a class="btn btn-link baloo" href="">Edit Profile</a>
            </div>
          </div>
          <p class="">&nbsp;</p>
          <div class="card">
            <div class="card-header"> Text Messages</div>
            <div class="card-body">
              <h4>Card title</h4>
              <h6 class="text-muted">Subtitle</h6>
              <p class=" p-y-1">Some quick example text to build on the card title .</p>
