  ...
  <nav class="navbar navbar-expand-md bg-primary navbar-dark">
    <div class="collapse navbar-collapse text-center justify-content-end" id="navbar2SupportedContent">
      ...
      <a class="btn navbar-btn ml-2 btn-link baloo text-white" href="dashboard.html">Dashboard
        <br> </a>
      <a class="btn navbar-btn ml-2 btn-link baloo text-secondary" href="inbox.html">Inbox
        <br> </a>
  ...
  <div class="py-5">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <p class="lead">&nbsp; &nbsp; &nbsp;&nbsp;</p>
          <div class="btn-group mr-auto text-right baloo">
            <button class="btn btn-primary dropdown-toggle" data-toggle="dropdown"> All Messages</button>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p class="">When guests contact you or send you reservation requests, you’ll see their messages here.</p>
            </div>
          </div>
        </div>
      </div>
