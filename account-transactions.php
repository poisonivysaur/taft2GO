    ...
    <div class="container">
      <div class="row">
        <div class="col-md-4 text-secondary">
          ...
          <a class="btn navbar-btn ml-2 btn-link baloo text-dark text-left ml-auto menu" href="account.html">Notifications</a>
          <a class="btn navbar-btn ml-2 btn-link baloo ml-auto menu text-left text-secondary" href="">Transaction History
            <br> </a>
        ...
        <div class="col-md-8">
          <table class="table">
            ...
            <tbody>
              <tr>
                <td>01/01/2017</td>
                <td>Binded to Dorm of John Warry</td>
                <td>Conditional</td>
              </tr>
              <tr>
                <td>01/02/2017</td>
                <td>Payed for John Warry's Dorm</td>
                <td>Done</td>
              </tr>
              <tr>
                <td>19/12/2017</td>
                <td>Left the John Warry's Dorm</td>
                <td>Done</td>
              </tr>
            </tbody>
          </table>
