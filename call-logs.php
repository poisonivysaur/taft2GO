...
<body>
  ...
  <div class="py-5">
    <div class="container">
      <div class="row">
          ...
          <div class="card">
            <div class="card-body">
              <p class="lead">Clients asking for a condo</p>
              <p class="" id = "logs"></p>
            </div>
          </div>
        </div>
  ...
  <script>
        $(document).ready(function(){
                ...
                $.ajax({
                    type: "GET",
                    url: "http://localhost:8080/taft2GO/call_logs",
                    dataType: "json",
                    success: function(response){
                        ...
                        for(var i = 0; i < jsonArray.length; i++){
                            ...
                            cards += '<p>facebook id:'+jsonArray[i].userid+' contact number:'+jsonArray[i].callerid+' </p>';
                        }
                        $('#logs').html(cards);
                    },
