  ...
  <nav class="navbar navbar-expand-md bg-primary navbar-dark">
    <div class="collapse navbar-collapse text-center justify-content-end" id="navbar2SupportedContent">
      ...
      <a class="btn navbar-btn ml-2 text-white btn-link baloo" href="inbox.html">&gt;
        <br> </a>
      <a class="btn navbar-btn ml-2 btn-link text-white baloo">2. Who's coming?
        <br> </a>
      <a class="btn navbar-btn ml-2 text-white btn-link baloo" href="stays.html">&gt;
        <br> </a>
      <a class="btn navbar-btn ml-2 text-white btn-link baloo" href="bookroom3.html">3. Confirm &amp; Pay
        <br> </a>
    </div>
    <div class="container">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-7">
          ...
          <div class="btn-group">
            <button class="btn btn-outline-primary dropdown-toggle" data-toggle="dropdown"> 1 Guest </button>
          ...
          <p class="lead"> </p>
          <p class="lead">Tell your host about your trip</p>
          ...
          <input class="form-control mr-sm-2 h-50 text-left" type="text" placeholder="Answer it here">
          <br>
          <a class="btn btn-primary baloo w-50" href="bookroom3.html">Continue
            <br> </a>
        </div>
        <div class="col-md-5">
          <div class="card">
