...
<body>
  <nav class="navbar navbar-expand-md navbar-dark bg-light m-0 style">
    ...
    <a class="btn navbar-btn ml-2 btn-light text-primary body baloo" href="listing.html">Host
      <br> </a>
  ...
  <nav class="navbar navbar-expand-md bg-primary navbar-dark">
    <div class="collapse navbar-collapse text-center justify-content-end" id="navbar2SupportedContent">
      ...
      <a class="btn navbar-btn ml-2 text-white btn-link baloo" href="stays.html">Stays
        <br> </a>
      <a class="btn navbar-btn ml-2 text-white btn-link baloo" href="profile.html">Profile
        <br> </a>
      <a class="btn navbar-btn ml-2 btn-link baloo text-secondary" href="account.html">Account </a>
    </div>
    <div class="container">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-4 text-secondary">
          <a class="btn navbar-btn ml-2 btn-link baloo ml-auto text-secondary text-left menu"></a>
          <a class="btn navbar-btn ml-2 btn-link baloo text-left ml-auto menu text-secondary" href="">Notifications</a>
          <a class="btn navbar-btn ml-2 btn-link baloo text-dark ml-auto menu text-left" href="account-transactions.html">Transaction History
            <br> </a>
          <a class="btn navbar-btn ml-2 btn-link baloo text-dark ml-auto menu text-left" href="account-settings.html">Settings
            <br> </a>
        </div>
        <div class="col-md-8">
          <div class="card">
            <div class="card-body">
              <div class="card">
                <div style="height:100%;">
                  <img src="acico.png" style="height:100%;width:10%;float:left;">
                  <div style="float:left;">
                    <div><b>
                        Message Recieved</b></div>
                    <div>Recieved email from John Warry.</div>
                    <div>01/01/2017</div>
                  </div>
                </div>
              </div>
              <br>
              <div class="card" style="background-color:rgba(0,255,0,0.5);">
                <div style="height:100%;">
                  <img src="approvalup.png" style="height:100%;width:10%;float:left;">
                  <div style="float:left;">
                    <div><b>
                        Approval Notice</b></div>
                    <div>John Warry has approved your request for his dorm</div>
                    <div>01/02/2017</div>
                  </div>
                </div>
              </div>
