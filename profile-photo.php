...
<body>
  ...
  <nav class="navbar navbar-expand-md bg-primary navbar-dark">
    <div class="collapse navbar-collapse text-center justify-content-end" id="navbar2SupportedContent">
      <ul class="navbar-nav"></ul>
      <a class="btn navbar-btn ml-2 btn-link baloo text-white">Dashboard
        <br> </a>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-4 text-secondary">
          <a class="btn navbar-btn ml-2 btn-link baloo ml-auto text-left menu text-dark" href="profile.html">Edit Profile</a>
          <a class="btn navbar-btn ml-2 btn-link baloo text-left ml-auto menu text-secondary" href="listing-reservation.html">Photos and Videos</a>
        ...
        <div class="col-md-8">
          <div class="card">
            ...
            <div class="card-body">
              <div class="row" align="center">
                <div class="col-md-12">
                  <img alt="Sherry" height="225" src="https://a0.muscache.com/defaults/user_pic-225x225.png?v=3" title="Sherry" width="225" class="m-0">
                  <p class="lead text-justify text-secondary">Clear frontal face photos are an important way for hosts and guests to learn about each other. It’s not much fun to host a landscape! Be sure to use a photo that clearly shows your face and doesn’t include any personal or sensitive info
                    you’d rather not have hosts or guests see. </p>
                  <a href="#" class="btn btn-outline-primary w-100 baloo">Upload a photo from you computer</a>
                </div>
              </div>
              <div class="row">
          ...
          <p class="lead">&nbsp;</p>
          <div class="card">
            <div class="card-header"> Profile Video</div>
            <div class="card-body">
              <img class="img-fluid d-block mx-auto" src="no video.png">
              <h4>&nbsp;</h4>
              <h4>Video Checklist</h4>
              <p class=" p-y-1">We love close-ups, but we suggest you sit at arm’s length.&nbsp;
                <br>You’ve got 30 seconds, so do your best to be concise.&nbsp;
                <br>Try to keep the light in front of you, not behind you.&nbsp;
                <br>Look into the camera to create that personal connection.&nbsp;
                <br>You’ll get a chance to preview your video before it uploads.</p>
              <div>&nbsp;</div>
              <h4>Tell the community a little bit about yourself</h4>
              <h6 class="text-muted">Start with your name and answer some of the following questions, or make up some of your own!</h6>
              <div>Where are you from?&nbsp;&nbsp;
                <div>What are some of your interests?&nbsp;
                  <br>What do you do in your spare time?&nbsp;</div>
              </div>
              <div>What is a fun fact about yourself?&nbsp;</div>
              <div>What are some of your favorite things?</div>
            </div>
          </div>
