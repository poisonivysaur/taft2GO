    ...
    <div class="container">
      <div class="row">
        <div class="col-md-4 text-secondary">
          ...
          <a class="btn navbar-btn ml-2 btn-link baloo ml-auto menu text-left text-dark" href="profile-trust.html">Trust and Verification</a>
          <a class="btn navbar-btn ml-2 btn-link baloo ml-auto menu text-left text-secondary" href="profile-reviews.html">Reviews</a>
        ...
        <div class="col-md-8">
          <div class="card">
            <div class="card-header"> Past Reviews</div>
            <div class="card-body">
              <h6 class="text-muted">Reviews are written at the end of a reservation through Airbnb. Reviews you’ve received will be visible both here and on your public profile.</h6>
              <p class=" p-y-1">No one has reviewed you yet.</p>
            </div>
          </div>
          <p class="">&nbsp;</p>
          <div class="card">
            <div class="card-header"> Reviews to Write </div>
            <div class="card-body">
              <p class=" p-y-1">Nobody to review right now. Looks like it’s time for another stay!</p>
            </div>
          </div>
          <p class="">&nbsp;</p>
          <div class="card">
            <div class="card-header"> Past Reviews You’ve Written </div>
